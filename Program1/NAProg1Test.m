% This is a script file to test your quadroot routine.
%
% Save this file in the Matlab working directory (with your other matlab files
% like startup.m).  Then in the command window type (without the >>)
% >> NAProg1Test
%
% It erases any file (in the Matlab path) called prog1run.txt, and
% writes output to a file in the Matlab working directory called prog1run.txt
%
% When your code is working to your satisfaction, print out and email me
% quadroot.m and prog1run.txt

diary off
if exist('prog1run.txt','file'),
    delete('prog1run.txt')
	disp(' ')
